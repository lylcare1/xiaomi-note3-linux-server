...
> 所有 5 个问题已通过源码核查 + 同 SoC 设备对照验证完成, 详见 [深度调研.md §8](./深度调研.md#8-待澄清问题与已澄清答案-2026-06-27-验证)。
...
> 完整内容见 [深度调研.md §10](./深度调研.md#10-内核源码深挖验证-2026-06-27)。来源: 克隆 tag `v6.19.10-sdm660` 到 `/tmp/sdm660-linux` 逐项核查。
...
- [docs/调研.md](./调研.md) - 高层调研
- [docs/深度调研.md](./深度调研.md) - pmOS 机制深度研究
- [docs/移植计划.md](./移植计划.md) - 执行计划
- [docs/文件模板.md](./文件模板.md) - 文件模板清单
...
- `/home/lyl/Documents/system/XiaoMiNote3/docs/工作进展.md` (执行日志)
