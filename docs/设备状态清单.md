...
> 创建日期: 2026-06-28 | 更新日期: 2026-07-02 (v4 systemd/rootfs 模式, r32 内核)
...
| 当前内容 | pmOS boot.img (r32, initramfs→systemd switch_root 模式) |
| kernel 版本 | `6.19.10-sdm660` (r32, sdm660-mainline 社区 fork, 含 cpufreq 补丁 + softdog watchdog) |
